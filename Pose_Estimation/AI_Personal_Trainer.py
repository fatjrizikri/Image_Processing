...
cap = cv2.VideoCapture("Video/Video_Arm_Traning.mp4")
...
while True:
    ...
    img = cv2.resize(img, (1280, 720)) # resize have problem because video i have high resolution
    # img =  cv2.imread("Video/Picture_Trainer_1.jpeg")
